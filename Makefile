PROJECT_NAME     := ws2812_blenano2
TARGETS          := nrf52832_blenano2
...
SRC_FILES += \
  ...
  $(PROJ_DIR)/../ext/ws2812b/ws2812b_driver.c \
  $(PROJ_DIR)/peripheral.cpp \
  $(PROJ_DIR)/ws2812b_service.cpp \
  $(PROJ_DIR)/app.cpp \
  $(PROJ_DIR)/main.cpp \
  $(SDK_ROOT)/components/libraries/uart/retarget.c \
...
default: nrf52832_blenano2

# Print all targets that can be built
help:
	@echo following targets are available:
	@echo 	nrf52832_blenano2
